  ...
  return (
    <div className="flex flex-col h-full bg-[#0a0a0a]">
      ...
      <div className="px-5 pt-4 pb-2">
        <span className="text-[10px] uppercase tracking-[0.2em] text-[#606060] font-mono font-semibold">
            ...
            <Link
              ...
              className={`flex items-center gap-3 px-3 py-2.5 text-sm tracking-wider font-medium rounded-sm transition-colors my-0.5 ${
                isActive
                  ...
                  : "text-[#d0d0d0] hover:text-[#0096D6] hover:bg-white/5 border-l-2 border-transparent"
              }`}
            >
      ...
      <div className="p-4 space-y-3">
        <div className="flex items-center gap-3 px-2">
          ...
          <div className="min-w-0">
            ...
            <div className="text-xs text-[#a0a0a0] truncate">{currentUser.email}</div>
          </div>
        </div>
        <Button
          onClick={handleLogout}
          variant="ghost"
          className="w-full justify-start text-[#a0a0a0] hover:text-white hover:bg-white/5 gap-2 font-medium text-sm"
        >
  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa]">
      ...
      <div className="hidden lg:flex">
        ...
        <aside className="fixed top-0 left-0 h-screen w-[260px] z-40 border-r border-white/10 overflow-y-auto">
      ...
      <div className="lg:hidden">
        {/* Mobile Top Bar */}
        <header className="sticky top-0 z-50" style={{ background: "rgba(10,10,10,0.95)", backdropFilter: "blur(12px)", borderBottom: "1px solid rgba(255,255,255,0.08)" }}>
          <div className="relative">
            <div
              className="absolute top-0 left-0 w-full h-[3px]"
              style={{
          ...
          <div className="px-4 h-[56px] flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
                ...
                <SheetContent side="left" className="w-[280px] bg-[#0a0a0a] border-r border-white/10 p-0">
